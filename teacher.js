...
async function logiInTeacherFunc() {
    ...
    try {
        ...
        if (loggedInUserInfo.length >= 1) {
            if ((loggedInUserInfo[0].dets.system.role == "admin") || (loggedInUserInfo[0].dets.system.role == "teacher")) { 
                setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                alert('Yure not an Admin or a Teacher ure a:  '+loggedInUserInfo[0].dets.system.role)
            }
