        ...
        card += `
            <div class="bar1 bar">
                                ...
                                <div class="bar_second">
                                    ...
                                    <span onclick="deleteEventsBtn(${i})"><img src="assets/icons/delete_light.png" alt=""></span>
...
let url = `https://sms-nclo.onrender.com`
...
function renderChartFunc() {
    ...
    const bgColors  = ['rgb(74, 54, 82)','rgb(255, 0, 123)','rgb(174, 126, 4)','rgb(3, 198, 136)','rgb(50, 151, 44)']
...
async function logiInTeacherFunc() {
    ...
    try {
        ...
        if (loggedInUserInfo.length >= 1) {
            if (loggedInUserInfo[0].dets.system.role == "admin") { 
                setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                alert('Yure not an Admin ure a:  '+loggedInUserInfo[0].dets.system.role)
            }
